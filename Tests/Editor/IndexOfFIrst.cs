    ...
    public static class IndexOfFirst
    {
        ...
        public static void Byte_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<byte> array = new NativeArray<byte>(64, Allocator.Persistent);
        ...
        public static void UShort_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<ushort> array = new NativeArray<ushort>(64, Allocator.Persistent);
                for (int j = 0; j < array.Length; j++)
                {
                    array[j] = 100;
                }
        ...
        public static void UInt_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<uint> array = new NativeArray<uint>(64, Allocator.Persistent);
                for (int j = 0; j < array.Length; j++)
                {
                    array[j] = 100;
                }
        ...
        public static void ULong_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<ulong> array = new NativeArray<ulong>(64, Allocator.Persistent);
                for (int j = 0; j < array.Length; j++)
                {
                    array[j] = 100;
                }
        ...
        public static void SByte_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<sbyte> array = new NativeArray<sbyte>(64, Allocator.Persistent);
                for (int j = 0; j < array.Length; j++)
                {
                    array[j] = 100;
                }
        ...
        public static void Short_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<short> array = new NativeArray<short>(64, Allocator.Persistent);
                for (int j = 0; j < array.Length; j++)
                {
                    array[j] = 100;
                }
        ...
        public static void Int_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<int> array = new NativeArray<int>(64, Allocator.Persistent);
                for (int j = 0; j < array.Length; j++)
                {
                    array[j] = 100;
                }
        ...
        public static void Long_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<long> array = new NativeArray<long>(64, Allocator.Persistent);
                for (int j = 0; j < array.Length; j++)
                {
                    array[j] = 100;
                }
        ...
        public static void Float_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<float> array = new NativeArray<float>(64, Allocator.Persistent);
                for (int j = 0; j < array.Length; j++)
                {
                    array[j] = 100;
                }
        ...
        public static void Double_Direct_EachIndex()
        {
            for (int i = 0; i < 64; i++)
            {
                ...
                NativeArray<double> array = new NativeArray<double>(64, Allocator.Persistent);
                for (int j = 0; j < array.Length; j++)
                {
                    array[j] = 100;
                }
